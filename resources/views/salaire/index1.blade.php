...
@section('content')
 ...
 <div class="container">
  ...
  <div class="card-body">
    ...
    <div class="row">
        <form action="{{ url('downloadPDFsal') }}" method="post">
        {!! csrf_field() !!}
        <div class="col-md-4">   
        <label>Matricule</label>
        <input type="search" name="matricule" id="matricule" class="form-control" placeholder="Entrez ici le matricule de l'Employé" >
        ...
        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="matricule" class="form-control" value="{{$emp->matricule}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Nom </label>
                                    <input type="text" name="nom" class="form-control" value="{{$emp->nom}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Prénoms</label>
                                    <input type="text" name="prenoms" class="form-control"  value="{{$emp->prenoms}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Poste</label>
                                    <input type="text" name="poste" class="form-control" value="{{$emp->poste}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Catégorie</label>
                                    <input type="text" name="categ" class="form-control" value="{{$emp->categ}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Nbre part</label>
                                    <input type="number" name="nbrepart" id="nbrepart" class="form-control" value="{{$emp->nbrepart}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Salaire de base</label>
                                    <input type="number" name="salbase" id="salbase" class="form-control" value="{{$emp->salbase}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Sursalaire</label>
                                    <input type="number" name="sursal" id="sursal" class="form-control" value="{{$emp->sursal}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" name="nation" id="nation" class="form-control" value="{{$emp->nation}}">
                                </div>
                            </div>
                        ...
                        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="avg_logement" id="avg_logement" class="form-control" value="{{$emp->avg_logement}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Vehicule</label>
                                    <input type="number" name="avg_vehicule" id="avg_vehicule" class="form-control" value="{{$emp->avg_vehicule}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Autres avantages</label>
                                    <input type="number" name="avg_otr" id="avg_otr" class="form-control" value="{{$emp->avg_otr}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="prime_ancien" id="prime_ancien" class="form-control" value="{{$emp->prime_ancien}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="prim_risq" id="prim_risq" class="form-control" value="{{$emp->prim_risq}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="prime_otr" id="prime_otr" class="form-control" value="{{$emp->prime_otr}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txhorair" id="txhorair" class="form-control" value="{{$emp->txhorair}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ind_nourriture" id="ind_nourriture" class="form-control" value="{{$emp->ind_nourriture}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Indemnite de logement</label>
                                    <input type="number" name="ind_logement" id="ind_logement" class="form-control" value="{{$emp->ind_logement}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Autres Indemnites Taxables</label>
                                     <input type="number" name="ind_otrtax" id="ind_otrtax" class="form-control" value="{{$emp->ind_otrtax}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ind_trsport" id="ind_trsport" class="form-control" value="{{$emp->ind_trsport}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Indemnite de salissure</label>
                                    <input type="number" name="ind_salissure" id="ind_salissure" class="form-control" value="{{$emp->ind_salissure}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Autres Indemnites</label>
                                     <input type="number" name="ind_otr" id="ind_otr" class="form-control" value="{{$emp->ind_otr}}">
                                </div>
                            </div>
                            ...
                            <table class="table">
                                ...
                                @foreach($salaire as $item)
                                    ...
                                    <td>
                                        ...
                                        <!--    <a href="{{ url('/salaire/' . $item->id . '/edit') }}" title="Edit emp brut imp."><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> -->
