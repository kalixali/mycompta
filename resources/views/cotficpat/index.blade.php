  ...
  <div class="card-body">
    ...
    <div class="row align-items-center mt-3">  
      <form action="{{ url('cotficpat') }}" method="post">
        ...
        <div class="col-md-4">
        <label>Matricule</label>
        <input type="text" name="matricule1" id="matricule1" class="form-control">
        </div>
        <div class="col-md-4">
        <label>Nom</label>
        ...
        <input type="number" name="salbimp" id="salbimp" class="form-control" value="0">
        </div>
        ...
        <div class="col-md-4">
            <div class="row">
                <div class="col-md-4">   
                <label>Taux (en %)</label>
                <input type="text" name="t_is_p" id="t_is_p" class="form-control" value="1.2">
                </div>
                <div class="col-md-8">
                <label>Impôt sur salaire</label>
                <input type="number" name="is_p" id="is_p" class="form-control" value="0">
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">   
                <label>Taux (en %)</label>
                <input type="text" name="t_ta_fdfp" id="t_ta_fdfp" class="form-control" value="0.4">
                </div>
                <div class="col-md-8">
                <label>Taxe d'apprentissage</label>
                <input type="number" name="ta_fdfp" id="ta_fdfp" class="form-control" value="0">
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">   
                <label>Taux (en %)</label>
                <input type="text" name="t_fpc_fdfp" id="t_fpc_fdfp" class="form-control" value="0.6">
                </div>
                <div class="col-md-8">
                <label>Contribution FPC</label>
                <input type="number" name="fpc_fdfp" id="fpc_fdfp" class="form-control" value="0">
                </div>
