      ...
      <form action="{{ url('cotsocpat') }}" method="post">
        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-4">   
                <label>Taux (en %)</label>
                <input type="text" name="t_prest_fam" id="t_prest_fam" class="form-control" value="5.75">
                </div>
                <div class="col-md-8">
                <label>Prestation familiale</label>
                <input type="number" name="prest_fam" id="prest_fam" class="form-control" value="0">
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">   
                <label>Taux (en %)</label>
                <input type="text" name="t_acc_trv" id="t_acc_trv" class="form-control" value="2">
                </div>
                <div class="col-md-8">
                <label>Accident de travail</label>
                <input type="number" name="acc_trv" id="acc_trv" class="form-control" value="0">
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4">   
                <label>Taux (en %)</label>
                <input type="text" name="t_cr_p" id="t_cr_p" class="form-control" value="7.7">
                </div>
                <div class="col-md-8">
                <label>Cotisation retraite</label>
                <input type="number" name="cr_p" id="cr_p" class="form-control" value="0">
                </div>
