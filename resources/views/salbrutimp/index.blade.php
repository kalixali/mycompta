    ...
    <div class="row align-items-center">  
      <form action="{{ url('salbrutimp') }}" method="post">
        {!! csrf_field() !!}
         <div class="col-md-4">   
        <label>Matricule</label>
        <input type="text" name="matricule" id="matricule" class="form-control" value="0">
        </div>       
        <div class="col-md-4">
        <label>Salaire de base</label>
        <input type="number" name="salbase" id="salbase" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>Sursalaire</label>
        <input type="number" name="sursal" id="idsursal" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>Total primes</label>
        <input type="number" name="totprimes" id="idtotprimes" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>Avantages en nat.</label>
        <input type="number" name="totavtagenat" id="idtotavtagenat" class="form-control" value="0" >
        </div>
        <div class="col-md-4">
        <label>Tot H.S.</label>
        <input type="number" name="totmhs" id="idtotmhs" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>Salaire b. imp.</label>
        <input type="number" name="salbimp" id="idsalbimp" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>CR</label>
        <input type="number" name="totcotsocemp" id="idtotcotsocemp" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>TOT. Fiscales</label>
        <input type="number" name="totcotficemp" id="idtotcotficemp" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>Salaire net</label>
        <input type="number" name="salnet" id="idsalnet" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>Tot. retenues</label>
        <input type="number" name="totretenues" id="idtotretenues" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>Salaire à payer</label>
        <input type="number" name="salpaye" id="idsalpaye" class="form-control" value="0">
        </div>
