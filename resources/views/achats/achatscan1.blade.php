...
@section('content')
 ...
 <div class="card">
  ...
  <div class="card-body">
     ...
     <div class="row align-items-center">  
      <form action="{{ url('achats') }}" method="post">
        ...
        <input type="text" name="numfact" id="numfact" class="inputbcolor form-control" autocomplete="off" value="{{$acha->numfact}}">
        <div id="facture_list"> </div>
        </div>
        <div class="col-md-6">
        <label>Fournisseur</label>
        <input type="text" name="siglefourn" id="siglefourn" class="form-control" autocomplete="off" value="{{$acha->siglefourn}}">
  ...
  <div class="table-responsive">
        ...
        <br/>
        <div class="row">
            <form action="{{ url('/achatscan') }}" method="GET">
            {!! csrf_field() !!}
            <div class="col-md-3">
