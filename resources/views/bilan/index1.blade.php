        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <form action = "{{ url('downloadPDFbilan') }}" method = "POST">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" name="from_date" class="form-group" value="{{$exec1}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" name="to_date" class="form-group" value="{{$exec2}}">
                                </div>
                            </div>
                        </div>
                        <br/>
